...
const sortPeopleBetter = (arr) => {
  ...
  arr.sort((a, b) => {
    ...
    if (a.lastName.toLowerCase() === b.lastName.toLowerCase() && a.firstName.toLowerCase() === b.firstName.toLowerCase() && a.age > b.age) {
      return 1;
    } else if (a.lastName.toLowerCase() === b.lastName.toLowerCase() && a.firstName.toLowerCase() === b.firstName.toLowerCase() && a.age < b.age) {
      return -1;
    }
  }); return arr;
};
